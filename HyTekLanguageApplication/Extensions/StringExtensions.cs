...
namespace HyTekLanguageApplication.Extensions
{
    public static class StringExtensions
    {
        private static readonly Dictionary<string, HashSet<string>> EventLookup = new Dictionary<string, HashSet<string>>
        {
            ...
            { "100M Hurdles", new HashSet<string> { "100MeterHurdles33\"" } },
            { "110M Hurdles", new HashSet<string> { "110MeterHurdles39\"" } },
            { "300M Hurdles", new HashSet<string> { "300MeterHurdles30\"", "300MeterHurdles36\"" } },
